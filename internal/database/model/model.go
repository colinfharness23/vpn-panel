...
type Inbound struct {
	...
	Protocol          Protocol `json:"protocol" form:"protocol" validate:"required,oneof=vmess vless trojan shadowsocks wireguard hysteria anytls http mixed tunnel tun mtproto" example:"vless"`
