...
rm -f -- /usr/local/sbin/nova-update /usr/local/sbin/nova-rollback /usr/local/sbin/nova-backup /usr/local/sbin/nova-rotate-admin-path /usr/local/sbin/nova-uninstall /usr/local/sbin/nova-finalize-domain /usr/local/sbin/nova-sync-line-cert /usr/local/sbin/nova-diagnose-active-subscription /usr/local/sbin/nova-diagnose-managed-ingress
