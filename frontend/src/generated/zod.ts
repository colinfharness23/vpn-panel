...
export const AdminSubscriptionSummarySchema = z.object({
  ...
  displayBenefits: z.record(z.string(), z.string()),
  downloadLimitMbps: z.number().int(),
  ...
  renewable: z.boolean(),
  resetCycle: z.string(),
  residentialRelayEnabled: z.boolean(),
  residentialRelayLimit: z.number().int(),
  slug: z.string(),
  sortOrder: z.number().int(),
  trafficBytes: z.number().int(),
  trafficMultiplierPermille: z.number().int(),
  updatedAt: z.string(),
  upgradable: z.boolean(),
  uploadLimitMbps: z.number().int(),
  visibility: z.string(),
});
...
export const ClientSchema = z.object({
  ...
  downloadLimitMbps: z.number().int().optional(),
  email: z.string(),
  enable: z.boolean(),
  ...
  trafficMultiplierPermille: z.number().int().optional(),
  updated_at: z.number().int().optional(),
  uploadLimitMbps: z.number().int().optional(),
});
...
export const CommercialPlanRequestSchema = z.object({
  ...
  displayBenefits: z.record(z.string(), z.string()),
  downloadLimitMbps: z.number().int().min(0).max(100000),
  id: z.string(),
  lineGroupIds: z.array(z.string()),
  ...
  residentialRelayEnabled: z.boolean(),
  residentialRelayLimit: z.number().int().min(0).max(20),
  slug: z.string().min(1).max(80),
  sortOrder: z.number().int(),
  trafficBytes: z.number().int().min(0),
  trafficMultiplierPermille: z.number().int().min(100).max(100000),
  upgradable: z.boolean(),
  uploadLimitMbps: z.number().int().min(0).max(100000),
...
export const CommercialSubscriptionUpdateRequestSchema = z.object({
  deviceLimit: z.number().int().min(0).max(1000),
  downloadLimitMbps: z.number().int().nullable().optional(),
  expiresAt: z.string(),
  planId: z.string().min(1),
  resetTraffic: z.boolean(),
  trafficMultiplierPermille: z.number().int().nullable().optional(),
  trafficQuota: z.number().int().min(0),
  uploadLimitMbps: z.number().int().nullable().optional(),
});
...
export const InboundSchema = z.object({
  ...
  port: z.number().int().min(0).max(65535),
  protocol: z.enum(['vmess', 'vless', 'trojan', 'shadowsocks', 'wireguard', 'hysteria', 'anytls', 'http', 'mixed', 'tunnel', 'tun', 'mtproto']),
  remark: z.string(),
  settings: z.unknown(),
  shareAddr: z.string(),
...
export const PlanCatalogItemSchema = z.object({
  ...
  downloadLimitMbps: z.number().int(),
  id: z.string(),
  lineGroupIds: z.array(z.string()).optional(),
  name: z.string(),
  nodeGroup: z.string(),
