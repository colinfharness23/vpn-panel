...
export const sections: readonly Section[] = [
  {
    ...
    description:
      "Email registration, subscriptions, payments, customer sessions, residential relay, and support.",
    endpoints: [
      {
        method: "GET",
        path: "/",
        summary: "Open the commercial customer authentication shell.",
      },
      {
        method: "GET",
        path: "/portal",
        summary: "Permanently redirect the legacy portal path to the root.",
      },
      {
        method: "GET",
        path: "/portal/*path",
      ...
      {
        method: "GET",
        path: "/api/v1/guest/auth-config",
        summary: "Return only the site and authentication configuration.",
      },
      {
        method: "POST",
        path: "/api/v1/guest/payments/alipay/notify",
        summary: "Verify and process an Alipay RSA2 payment notification.",
      },
      {
        method: "GET",
        path: "/api/v1/guest/payments/epay/notify",
        summary: "Verify and process an Epay MD5 payment notification.",
      },
      {
        method: "POST",
        path: "/api/v1/guest/payments/epay/notify",
      ...
      {
        method: "GET",
        path: "/api/v1/guest/payments/codepay/notify",
        summary: "Verify and process a CodePay MD5 payment notification.",
      },
      {
        method: "POST",
        path: "/api/v1/guest/payments/codepay/notify",
      ...
      {
        method: "GET",
        path: "/api/v1/passport/csrf-token",
        summary: "Create a customer CSRF token.",
      },
      {
        method: "POST",
        path: "/api/v1/passport/send-code",
        summary: "Send a Gmail verification code.",
      },
      {
        method: "POST",
        path: "/api/v1/passport/register",
      ...
      {
        method: "POST",
        path: "/api/v1/passport/reset-password",
        summary: "Reset a customer password.",
      },
      {
        method: "POST",
        path: "/api/v1/passport/logout",
        summary: "Revoke the active session.",
      },
      {
        method: "GET",
        path: "/api/v1/user/bootstrap",
        summary: "Return plans, notices, guides, clients, and payment methods for an authenticated customer.",
      },
      {
        method: "GET",
        path: "/api/v1/user/applications/:id/download",
        summary: "Download a client installer as an authenticated customer.",
      },
      {
        method: "GET",
        path: "/api/v1/user/dashboard",
        summary: "Return subscription, usage, notices, and orders.",
      },
      {
        method: "GET",
      ...
      },
      {
        method: "POST",
        path: "/api/v1/user/orders",
        summary: "Create a 15-minute plan order.",
      },
      {
        method: "POST",
        path: "/api/v1/user/orders/:id/pay",
        summary:
          "Create a payment using the enabled provider selected in the request body.",
      },
      {
        method: "POST",
        path: "/api/v1/user/orders/:id/demo-pay",
        summary: "Confirm a development demo payment.",
      },
      {
        method: "POST",
        path: "/api/v1/user/subscription/rotate",
        summary: "Rotate the native subscription identifier.",
      },
      {
        method: "GET",
        path: "/api/v1/user/subscription/qr",
        summary: "Return a subscription QR code.",
      },
      {
        method: "GET",
        path: "/api/v1/user/residential-relays",
        summary:
          "List plan-authorized lines and the customer’s residential SOCKS5 relays.",
      },
      {
        method: "POST",
        path: "/api/v1/user/residential-relays",
        summary:
          "Route one authorized line through a customer-owned residential SOCKS5 proxy.",
      },
      {
        method: "PUT",
        path: "/api/v1/user/residential-relays/:id",
        summary: "Update a customer-owned residential SOCKS5 relay.",
      },
      {
        method: "DELETE",
        path: "/api/v1/user/residential-relays/:id",
        summary:
          "Remove a residential relay and restore the line’s normal egress.",
      },
      {
        method: "GET",
        path: "/api/v1/user/residential-relays/:id/qr",
        summary: "Return a QR code for the selected relayed line.",
      },
      {
        method: "GET",
      ...
      },
      {
        ...
        summary:
          "Change the authenticated customer password and rotate active sessions.",
      },
      {
        method: "GET",
  ...
  },
  {
    ...
    description: "Role-protected commercial operations for the NOVA panel.",
    endpoints: [
      {
        method: "GET",
        path: "/panel/api/commercial/overview",
        summary: "Return commercial KPIs.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/customers",
        summary: "Search customers.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/customers",
        summary: "Manually create a customer.",
      },
      {
        method: "DELETE",
        path: "/panel/api/commercial/customers",
        summary:
          "Permanently delete multiple customers and their related data.",
      },
      {
        method: "PATCH",
        path: "/panel/api/commercial/customers/:id",
        summary: "Update a customer.",
      },
      {
        method: "DELETE",
        path: "/panel/api/commercial/customers/:id",
        summary: "Permanently delete a customer and their related data.",
      },
      {
        method: "PUT",
        path: "/panel/api/commercial/customers/:id/subscription",
        summary: "Manually create or replace a customer subscription.",
      },
      {
        method: "DELETE",
        path: "/panel/api/commercial/customers/:id/subscription",
        summary: "Revoke a customer subscription and remove its panel client.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/plans",
        summary: "List plans and prices.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/plans",
      ...
      {
        method: "POST",
        path: "/panel/api/commercial/plan-prices",
        summary: "Save a plan price.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/line-sources",
        summary: "List encrypted subscription and manual line sources.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/line-sources",
        summary: "Create or update a subscription URL source.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/line-sources/:id/refresh",
        summary: "Queue an immediate subscription source refresh.",
      },
      {
        method: "DELETE",
        path: "/panel/api/commercial/line-sources/:id",
        summary: "Delete a line source after administrator reauthentication.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/line-imports/preview",
        summary: "Validate protocol links and report duplicates.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/line-imports/commit",
        summary: "Commit valid protocol links to the unassigned node pool.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/line-nodes",
        summary: "Filter imported line nodes by source, group, or status.",
      },
      {
        method: "PUT",
      ...
      {
        method: "POST",
        path: "/panel/api/commercial/line-nodes/:id/probe",
        summary: "Queue provisioning and a real outbound probe for one node.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/line-groups",
        summary: "List line groups with plan and health totals.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/line-groups",
        summary: "Create or update a line group.",
      },
      {
        method: "DELETE",
        path: "/panel/api/commercial/line-groups/:id",
        summary: "Delete an unused line group after administrator reauthentication.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/orders",
        summary: "Search orders.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/orders/:id/retry",
        summary: "Retry provisioning.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/notices",
      ...
      {
        method: "GET",
        path: "/panel/api/commercial/articles",
        summary: "List knowledge articles.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/articles",
        summary: "Save a knowledge article.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/applications",
        summary: "List client downloads.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/applications",
        summary: "Save client download metadata.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/applications/:id/package",
        summary: "Upload or replace a client installer package.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/tickets",
        summary: "List customer tickets.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/tickets/:id/messages",
        summary: "List ticket messages.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/tickets/:id/reply",
        summary: "Reply to a ticket.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/coupons",
      ...
      {
        method: "GET",
        path: "/panel/api/commercial/gift-cards",
        summary: "List gift cards.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/gift-cards",
        summary: "Issue gift cards.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/commissions",
        summary: "List invitation commissions.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/commissions/:id/settle",
        summary: "Settle a commission.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/settings",
        summary: "Return commercial settings.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/settings",
        summary: "Save a commercial setting.",
      },
      {
        method: "PUT",
        path: "/panel/api/commercial/payment-settings",
        summary:
          "Save independently enabled Epay, AlipayF2F, and CodePay settings.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/site-settings",
        summary:
          "Return site identity, registration, subscription URL, and currency settings.",
      },
      {
        method: "PUT",
        path: "/panel/api/commercial/site-settings",
        summary:
          "Save site identity, registration, subscription URL, and currency settings.",
      },
      {
        method: "PUT",
        path: "/panel/api/commercial/site-settings/logo",
        summary: "Validate and immediately apply the public site logo.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/security-settings",
        summary: "Return registration and password security settings.",
      },
      {
        method: "PUT",
        path: "/panel/api/commercial/security-settings",
        summary: "Save registration and password security settings.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/subscription-settings",
        summary:
          "Return customer self-service and subscription output settings.",
      },
      {
        method: "PUT",
        path: "/panel/api/commercial/subscription-settings",
        summary: "Save customer self-service and subscription output settings.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/invitation-settings",
        summary:
          "Return invitation and non-withdrawable account-credit policy settings.",
      },
      {
        method: "PUT",
        path: "/panel/api/commercial/invitation-settings",
        summary:
          "Save invitation and non-withdrawable account-credit policy settings.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/email-templates",
        summary: "List persistent customer email templates.",
      },
      {
        method: "PUT",
        path: "/panel/api/commercial/email-templates/:key",
        summary: "Update a customer email template.",
      },
      {
        method: "POST",
        path: "/panel/api/commercial/emails/send",
        summary:
          "Queue a personalized email for selected, active, or subscribed customers.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/audit",
        summary: "Return audit events.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/role",
        summary: "Return the current commercial role.",
      },
      {
        method: "GET",
        path: "/panel/api/commercial/roles",
        summary: "List panel administrators and commercial roles.",
      },
      {
        method: "PUT",
        path: "/panel/api/commercial/roles/:userId",
        summary: "Assign an administrator role.",
      },
    ],
  },
  {
...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        summary: "Check whether a newer panel release is available on GitHub.",
      },
      {
        method: "GET",
      ...
      },
      {
        ...
        summary:
          "Report whether this installation can run the Ubuntu server migration workflow and return its deployment context.",
      },
      {
        method: "POST",
        path: "/panel/api/server/migration/preflight",
        summary:
          "Verify SSH credentials, pin the target host key, and check Ubuntu version, architecture, disk, DNS, and existing installation state without modifying the target.",
        params: [
          {
            name: "host",
            in: "body (json)",
            type: "string",
            desc: "Target server IPv4 or IPv6 address.",
          },
          {
            name: "port",
            in: "body (json)",
          ...
          { name: "username", in: "body (json)", type: "string" },
          {
            ...
            in: "body (json)",
            type: "string",
            desc: "Used in memory for this request only.",
          },
        ],
      },
      {
        ...
        summary:
          "Start the confirmed migration after repeating preflight with the pinned SSH host key. Requires administrator reauthentication headers.",
        params: [
      ...
      },
      {
        ...
        summary:
          "Return the current migration step, progress, safe logs, result URLs, or failure reason for an in-memory migration job.",
      ...
      },
      {
        ...
        summary:
          "Run a live TLS 1.3 probe against a candidate REALITY target and return a feasibility verdict (TLS 1.3 + h2 + X25519 + trusted certificate) plus the certificate SAN DNS names.",
        params: [
          {
            name: "target",
            in: "body (form)",
...

  {
    ...
    title: "Nodes",
    description:
      "Manage remote NOVA panels acting as nodes for a central panel. All endpoints under /panel/api/nodes.",
    endpoints: [
      {
        method: "GET",
...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        summary:
          "Restart the entire panel process after a 3-second grace period. The connection drops immediately; the panel comes back online ~5-10 seconds later.",
      },
      {
        method: "POST",
      ...
      },
      {
        ...
        summary:
          "Validate a public HTTPS Telegram webhook URL, register it for the enabled bot, and switch the bot to webhook delivery.",
      ...
      },
      {
        ...
        summary:
          "Remove the Telegram webhook and return the enabled bot to long-polling delivery.",
      },
      {
        method: "GET",
