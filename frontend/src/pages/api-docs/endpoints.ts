...
export const sections: readonly Section[] = [
  {
    ...
    title: 'Commercial customer portal',
    description: 'Gmail registration, subscriptions, Alipay payment, customer sessions, and support.',
    endpoints: [
      { method: 'GET', path: '/portal', summary: 'Open the commercial customer portal.' },
      { method: 'GET', path: '/portal/*path', summary: 'Serve portal routes.' },
      { method: 'GET', path: '/api/v1/guest/bootstrap', summary: 'Return public plans, notices, guides, clients, and site settings.' },
      { method: 'POST', path: '/api/v1/guest/payments/alipay/notify', summary: 'Verify and process an Alipay RSA2 payment notification.' },
      { method: 'GET', path: '/api/v1/guest/payments/epay/notify', summary: 'Verify and process an Epay MD5 payment notification.' },
      { method: 'POST', path: '/api/v1/guest/payments/epay/notify', summary: 'Verify and process an Epay MD5 payment notification.' },
      { method: 'GET', path: '/api/v1/guest/payments/codepay/notify', summary: 'Verify and process a CodePay MD5 payment notification.' },
      { method: 'POST', path: '/api/v1/guest/payments/codepay/notify', summary: 'Verify and process a CodePay MD5 payment notification.' },
      { method: 'GET', path: '/api/v1/passport/csrf-token', summary: 'Create a customer CSRF token.' },
      { method: 'POST', path: '/api/v1/passport/send-code', summary: 'Send a Gmail verification code.' },
      { method: 'POST', path: '/api/v1/passport/register', summary: 'Register a customer.' },
      { method: 'POST', path: '/api/v1/passport/login', summary: 'Log in a customer.' },
      { method: 'POST', path: '/api/v1/passport/reset-password', summary: 'Reset a customer password.' },
      { method: 'POST', path: '/api/v1/passport/logout', summary: 'Revoke the active session.' },
      { method: 'GET', path: '/api/v1/user/dashboard', summary: 'Return subscription, usage, notices, and orders.' },
      { method: 'GET', path: '/api/v1/user/orders', summary: 'List customer orders.' },
      { method: 'POST', path: '/api/v1/user/orders', summary: 'Create a 15-minute plan order.' },
      { method: 'POST', path: '/api/v1/user/orders/:id/pay', summary: 'Create a payment using the enabled provider selected in the request body.' },
      { method: 'POST', path: '/api/v1/user/orders/:id/demo-pay', summary: 'Confirm a development demo payment.' },
      { method: 'POST', path: '/api/v1/user/subscription/rotate', summary: 'Rotate the native subscription identifier.' },
      { method: 'GET', path: '/api/v1/user/subscription/qr', summary: 'Return a subscription QR code.' },
      { method: 'GET', path: '/api/v1/user/sessions', summary: 'List active customer sessions.' },
      { method: 'DELETE', path: '/api/v1/user/sessions/:id', summary: 'Revoke a customer session.' },
      { method: 'POST', path: '/api/v1/user/account/password', summary: 'Change the authenticated customer password and rotate active sessions.' },
      { method: 'GET', path: '/api/v1/user/tickets', summary: 'List support tickets.' },
      { method: 'POST', path: '/api/v1/user/tickets', summary: 'Create a support ticket.' },
    ],
  },
  {
    id: 'commercial-administration',
    title: 'Commercial administration',
    description: 'Role-protected commercial operations for the 3X-UI panel.',
    endpoints: [
      { method: 'GET', path: '/panel/api/commercial/overview', summary: 'Return commercial KPIs.' },
      { method: 'GET', path: '/panel/api/commercial/customers', summary: 'Search customers.' },
      { method: 'POST', path: '/panel/api/commercial/customers', summary: 'Manually create a customer.' },
      { method: 'DELETE', path: '/panel/api/commercial/customers', summary: 'Permanently delete multiple customers and their related data.' },
      { method: 'PATCH', path: '/panel/api/commercial/customers/:id', summary: 'Update a customer.' },
      { method: 'DELETE', path: '/panel/api/commercial/customers/:id', summary: 'Permanently delete a customer and their related data.' },
      { method: 'PUT', path: '/panel/api/commercial/customers/:id/subscription', summary: 'Manually create or replace a customer subscription.' },
      { method: 'DELETE', path: '/panel/api/commercial/customers/:id/subscription', summary: 'Revoke a customer subscription and remove its 3X-UI client.' },
      { method: 'GET', path: '/panel/api/commercial/plans', summary: 'List plans and prices.' },
      { method: 'POST', path: '/panel/api/commercial/plans', summary: 'Save a plan.' },
      { method: 'POST', path: '/panel/api/commercial/plan-prices', summary: 'Save a plan price.' },
      { method: 'GET', path: '/panel/api/commercial/orders', summary: 'Search orders.' },
      { method: 'POST', path: '/panel/api/commercial/orders/:id/retry', summary: 'Retry provisioning.' },
      { method: 'GET', path: '/panel/api/commercial/notices', summary: 'List notices.' },
      { method: 'POST', path: '/panel/api/commercial/notices', summary: 'Save a notice.' },
      { method: 'GET', path: '/panel/api/commercial/articles', summary: 'List knowledge articles.' },
      { method: 'POST', path: '/panel/api/commercial/articles', summary: 'Save a knowledge article.' },
      { method: 'GET', path: '/panel/api/commercial/applications', summary: 'List official clients.' },
      { method: 'POST', path: '/panel/api/commercial/applications', summary: 'Save an official client.' },
      { method: 'GET', path: '/panel/api/commercial/tickets', summary: 'List customer tickets.' },
      { method: 'GET', path: '/panel/api/commercial/tickets/:id/messages', summary: 'List ticket messages.' },
      { method: 'POST', path: '/panel/api/commercial/tickets/:id/reply', summary: 'Reply to a ticket.' },
      { method: 'GET', path: '/panel/api/commercial/coupons', summary: 'List coupons.' },
      { method: 'POST', path: '/panel/api/commercial/coupons', summary: 'Save a coupon.' },
      { method: 'GET', path: '/panel/api/commercial/gift-cards', summary: 'List gift cards.' },
      { method: 'POST', path: '/panel/api/commercial/gift-cards', summary: 'Issue gift cards.' },
      { method: 'GET', path: '/panel/api/commercial/commissions', summary: 'List invitation commissions.' },
      { method: 'POST', path: '/panel/api/commercial/commissions/:id/settle', summary: 'Settle a commission.' },
      { method: 'GET', path: '/panel/api/commercial/settings', summary: 'Return commercial settings.' },
      { method: 'POST', path: '/panel/api/commercial/settings', summary: 'Save a commercial setting.' },
      { method: 'PUT', path: '/panel/api/commercial/payment-settings', summary: 'Save independently enabled Epay, AlipayF2F, and CodePay settings.' },
      { method: 'GET', path: '/panel/api/commercial/site-settings', summary: 'Return site identity, registration, subscription URL, and currency settings.' },
      { method: 'PUT', path: '/panel/api/commercial/site-settings', summary: 'Save site identity, registration, subscription URL, and currency settings.' },
      { method: 'PUT', path: '/panel/api/commercial/site-settings/logo', summary: 'Validate and immediately apply the public site logo.' },
      { method: 'GET', path: '/panel/api/commercial/security-settings', summary: 'Return registration and password security settings.' },
      { method: 'PUT', path: '/panel/api/commercial/security-settings', summary: 'Save registration and password security settings.' },
      { method: 'GET', path: '/panel/api/commercial/subscription-settings', summary: 'Return customer self-service and subscription output settings.' },
      { method: 'PUT', path: '/panel/api/commercial/subscription-settings', summary: 'Save customer self-service and subscription output settings.' },
      { method: 'GET', path: '/panel/api/commercial/invitation-settings', summary: 'Return invitation and non-withdrawable account-credit policy settings.' },
      { method: 'PUT', path: '/panel/api/commercial/invitation-settings', summary: 'Save invitation and non-withdrawable account-credit policy settings.' },
      { method: 'GET', path: '/panel/api/commercial/email-templates', summary: 'List persistent customer email templates.' },
      { method: 'PUT', path: '/panel/api/commercial/email-templates/:key', summary: 'Update a customer email template.' },
      { method: 'POST', path: '/panel/api/commercial/emails/send', summary: 'Queue a personalized email for selected, active, or subscribed customers.' },
      { method: 'GET', path: '/panel/api/commercial/audit', summary: 'Return audit events.' },
      { method: 'GET', path: '/panel/api/commercial/role', summary: 'Return the current commercial role.' },
      { method: 'GET', path: '/panel/api/commercial/roles', summary: 'List panel administrators and commercial roles.' },
      { method: 'PUT', path: '/panel/api/commercial/roles/:userId', summary: 'Assign an administrator role.' },
    ],
  },
  {
    id: 'authentication',
...

  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/panel/api/server/migration/source',
        summary: 'Report whether this installation can run the Ubuntu server migration workflow and return its deployment context.',
      },
      {
        method: 'POST',
        path: '/panel/api/server/migration/preflight',
        summary: 'Verify SSH credentials, pin the target host key, and check Ubuntu version, architecture, disk, DNS, and existing installation state without modifying the target.',
        params: [
          { name: 'host', in: 'body (json)', type: 'string', desc: 'Target server IPv4 or IPv6 address.' },
          { name: 'port', in: 'body (json)', type: 'integer', defaultValue: 22 },
          { name: 'username', in: 'body (json)', type: 'string' },
          { name: 'password', in: 'body (json)', type: 'string', desc: 'Used in memory for this request only.' },
        ],
      },
      {
        method: 'POST',
        path: '/panel/api/server/migration/start',
        summary: 'Start the confirmed migration after repeating preflight with the pinned SSH host key. Requires administrator reauthentication headers.',
        params: [
          { name: 'X-Admin-Password', in: 'header', type: 'string' },
          { name: 'X-Admin-2FA', in: 'header', type: 'string', optional: true },
          { name: 'host', in: 'body (json)', type: 'string' },
          { name: 'port', in: 'body (json)', type: 'integer', defaultValue: 22 },
          { name: 'username', in: 'body (json)', type: 'string' },
          { name: 'password', in: 'body (json)', type: 'string' },
          { name: 'fingerprint', in: 'body (json)', type: 'string' },
          { name: 'confirmed', in: 'body (json)', type: 'boolean' },
        ],
      },
      {
        method: 'GET',
        path: '/panel/api/server/migration/status/:id',
        summary: 'Return the current migration step, progress, safe logs, result URLs, or failure reason for an in-memory migration job.',
...

  {
    ...
    endpoints: [
      ...
      {
        method: 'POST',
        path: '/panel/api/setting/configureTgWebhook',
        summary: 'Validate a public HTTPS Telegram webhook URL, register it for the enabled bot, and switch the bot to webhook delivery.',
        body: '{\n  "url": "https://vpn.example.com/telegram/webhook"\n}',
      },
      {
        method: 'POST',
        path: '/panel/api/setting/deleteTgWebhook',
        summary: 'Remove the Telegram webhook and return the enabled bot to long-polling delivery.',
      },
      {
        method: 'GET',
